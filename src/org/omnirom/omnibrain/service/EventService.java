                ...
                switch (action) {
                    ...
                    case BluetoothA2dp.ACTION_CONNECTION_STATE_CHANGED:
                        ...
                        if (connect) {
                            ...
                            mMediaPlayerEvents.runEvent(context, getPrefs(context), "a2dp", mOverlayWidth, device.getName());
                        }
                    ...
                    case AudioManager.ACTION_HEADSET_PLUG:
                        if (intent.getIntExtra("state", 0) == 1) {
                            ...
                            mMediaPlayerEvents.runEvent(context, getPrefs(context), "headset", mOverlayWidth, null);
                        } else {

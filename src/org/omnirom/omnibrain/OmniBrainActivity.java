...
import org.omnirom.omnibrain.fragments.BTDeviceEventsFragment;
    ...
    public boolean onPreferenceStartFragment(PreferenceFragment caller, Preference pref) {
        ...
        switch (pref.getFragment()) {
            ...
            case "org.omnirom.omnibrain.fragments.PublicNetworkEventsSettings":
                ...
                break;
            case "org.omnirom.omnibrain.fragments.BTDeviceEventsFragment":
                transaction.replace(R.id.content_frame, new BTDeviceEventsFragment(this));
                break;
            default:
                return false;
        }

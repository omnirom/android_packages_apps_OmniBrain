...
public class MediaPlayerEvents {
    ...
    public static void runEvent(Context context, SharedPreferences prefs, String mode, int overlayWidth) {
    ...
    // TODO: NOT WORKING
    public static void sendStartEvent(final Context context) {
    ...
    private static List<String> getAvailableAppsList(Context context, String app_list) {
    ...
    private static void dispatchMediaKeyToAudioService(Context context, int keycode) {
